...

{
                    ...
                    className={` hover:bg-gray-400 p-5 rounded-t-md hover:rounded-t-xl ${showCreateEvents? 'bg-gray-400' : 'bg-gray-300'}`}>Create Events</li>
                        )
                    }

{
                    ...
                    className={` hover:bg-gray-400 p-5 rounded-t-md hover:rounded-t-xl ${showMyEvents? 'bg-gray-400' : 'bg-gray-300'}`}>My Events</li>
                        )
                    }
                </ul>
                            ...
                            <div className='flex flex-col gap-5'>
                                {
                                    previousDonations.map((donation, index) => {
                                        return (
                                            <div key={index} className='w-full bg-white p-3 rounded-lg flex gap-5'>
                                                <img src={donation.image} alt="" className='w-40 h-40 object-cover rounded-lg'/>
                            ...
                            <div className='flex flex-col gap-5'>
                                {
                                    upcomingEvents.map((event, index) => {
                                        return (
                                            <div key={index} className='w-full bg-white p-3 rounded-lg flex gap-5'>
                                                <img src={event.image} alt="" className='w-40 h-40 object-cover rounded-lg'/>
                                                <div className='flex flex-col justify-between p-3'>
                                                    <div>
                                                            ...
                                                            event.sponsorsList.map((sponsor, index) => {
                                                                return (
                                                                    <div key={index} className='flex gap-5'>
                                                                        <img src={sponsor.logo} alt="" className='w-full h-20 object-cover'/>
                                                                    </div>
                                                                )
                                                            })
                                                        }
